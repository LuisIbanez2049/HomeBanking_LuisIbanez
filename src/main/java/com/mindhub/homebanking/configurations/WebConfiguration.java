    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(authorize ->
                        authorize
                                .requestMatchers("/api/auth/current", "/api/clients/current/accounts", "/api/clients/currentAccount/delete", "/api/loans/currentClient" ,"/api/clients/current/cards", "/api/transactions", "/api/clients/accounts/**").hasRole("CLIENT")
                                ...
                                .requestMatchers("/api/auth/login", "/api/auth/register", "/api/external/payment").permitAll()
